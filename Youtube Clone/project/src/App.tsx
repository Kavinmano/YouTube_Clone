...
import { Menu, Search, Bell, User, Home, Compass, Library, History, ThumbsUp, Clock, ChevronDown, Play } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-[#0f0f0f] text-white">
      ...
      <header className="fixed top-0 z-50 w-full bg-[#0f0f0f] border-b border-gray-800">
        <div className="flex items-center justify-between px-4 h-14">
          ...
          <div className="flex-1 max-w-2xl mx-4">
            <div className="flex">
              <div className="flex-1 flex items-center bg-[#222222] rounded-l-full px-4">
                <input
                  type="text"
                  placeholder="Search"
              ...
              <button className="px-6 bg-[#222222] border-l border-gray-700 rounded-r-full hover:bg-gray-700">
      ...
      <div className="flex pt-14">
        {/* Sidebar */}
        <aside className={`fixed left-0 top-14 h-full bg-[#0f0f0f] transition-all ${
          ...
          <div className="p-2">
            <div className="space-y-1">
              ...
              <button className="flex items-center w-full p-2 rounded-lg hover:bg-gray-800">
                ...
                {isMenuOpen && <span className="ml-4">Library</span>}
              </button>
              <button className="flex items-center w-full p-2 rounded-lg hover:bg-gray-800">
              ...
              <button className="flex items-center w-full p-2 rounded-lg hover:bg-gray-800">
                ...
                {isMenuOpen && <span className="ml-4">Watch Later</span>}
              </button>
              {isMenuOpen && (
                <button className="flex items-center w-full p-2 rounded-lg hover:bg-gray-800">
        ...
        {/* Video Grid */}
        <main className={`flex-1 ${isMenuOpen ? 'ml-60' : 'ml-20'} p-6`}>
